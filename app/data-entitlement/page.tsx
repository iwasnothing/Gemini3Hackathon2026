...
export default function DataEntitlementPage() {
  ...
  const getPermissionIcon = (permission: string) => {
    switch (permission) {
      ...
      case 'write':
        return <Edit className="w-4 h-4 text-soft-mint" />;
      case 'delete':
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 glass rounded-xl p-6">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-soft-mint">Data Entitlement</h1>
          </div>
        ...
        {entitledResources.length === 0 ? (
          <div className="glass rounded-xl p-12 text-center">
            <Shield className="w-16 h-16 text-cream mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-soft-mint mb-2">No Entitlements Found</h3>
          ...
          <div className="space-y-6">
            ...
            {grouped.dataSource.length > 0 && (
              <div>
                <h2 className="text-xl font-semibold text-soft-mint mb-4 flex items-center gap-2">
                  ...
                  {grouped.dataSource.map((resource) => (
                    ...
                    >
                      ...
                      <div className="space-y-2">
                        <div className="text-sm text-cream">Permissions:</div>
                        ...
                        <div className="text-xs text-cream mt-3">
